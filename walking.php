...
<html>
    ...
    <style>
body {
	background: url('walking.jpg')no-repeat;
...
.para-2 a {
  ...
  <body>
	...
	<label>No of kms</label>
        <input type="int"   name="fromdate" placeholder="enter the kms for walk" />
        
        <label>No of times</label>
        <input type="int"   name="todate" placeholder="enter the no of times of walking" />

	<label>Pick up location</label>
        <input type="int"   name="totaldays" placeholder=" enter the location pick up" " />
 ...
 <?php
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
			...
			$query = "INSERT INTO `pet walking` (`owner name`, `pet name`, `pet type`, `breed`, `walking kms`, `no of times`, `pick up location`) VALUES ('$ownername', '$petname', '$type', '$breed', '$fromdate', '$todate', '$totaldays')";
