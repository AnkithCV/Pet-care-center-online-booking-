...
<html>
    ...
    <style>
body {
	background: url('joy.jpg')no-repeat;
...
.para-2 a {
  ...
  <body>
     <div class="signup-box">
      ...
      <h4>Book soon for your pet grooming</h4>
	...
	<label>AGE</label>
        <input type="int"   name="fromdate" placeholder="enter the age" />
        
        <label>GROOMING STYLE</label>
        <input type="text"   name="todate" placeholder="enter style " />
 ...
 <?php
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
			...
			$query = "INSERT INTO `grooming` (`owner name`, `pet name`, `pet type`, `breed`, `age`, `groom type`, `pick up location`) VALUES ('$ownername', '$petname', '$type', '$breed', '$fromdate', '$todate', '$totaldays')";
